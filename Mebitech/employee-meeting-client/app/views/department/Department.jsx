...
var Department = React.createClass({
		...
		return (
			<div>
				...
				<BootstrapTable data={this.state.data}
					...
					<TableHeaderColumn dataField="description">DESCRIPTON</TableHeaderColumn>
	...
	onDeleteBtnClicked: function() {
		...
		axios.delete('http://localhost:9090/departments/' + this.state.selectedDepartmentId)
	...
	refreshTable: function() {
		...
		axios.get('http://localhost:9090/departments')
		.then(function (dep) {
