...
var Employee = React.createClass({
    ...
    return(
      <div>
        <ButtonGroup className="m-10">
          ...
          <Button bsStyle="warning" disable={this.state.selectedEmployeeId === null} onClick={this.openUpdateModal}><Glyphicon glyph="refresh" />Update</Button>
          <Button bsStyle="danger" disable={this.state.selectedEmployeeId === null} onClick={this.onDeleteBtnClicked}><Glyphicon glyph="trash" />Delete</Button>
        </ButtonGroup>
  ...
  onDeleteBtnClicked: function() {
		...
		axios.delete('http://localhost:9090/employees/' + this.state.selectedEmployeeId)
  ...
  getEmployeeById: function(id) {
	...
	getEmployees: function() {
	  return axios.get('http://localhost:9090/employees');
	},

  getDepartments: function() {
	  return axios.get('http://localhost:9090/departments');
	},
