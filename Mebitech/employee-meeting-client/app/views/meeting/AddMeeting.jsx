...
var AddMeeting = React.createClass({
					...
					<form>
						<FormGroup>
							...
							<Select
								...
								multi={true}
								value={this.props.parent.getDepartmentOptions(this.state.addObject.department)}
	...
	clearAddObject: function() {
		...
		this.state.addObject.department='';
	},
	...
	onAddMeetingDepartmentChange: function(selection) {
		...
		if (selection === null) {
			this.state.addObject.department = null;
		} else {
			...
			this.state.addObject.department = departments;
		}
		this.forceUpdate();
	},
	...
	onAddBtnClicked: function() {
		...
		//Save meeting
		axios.post('http://localhost:9090/meetings/', this.state.addObject)
