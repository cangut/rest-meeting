...
var Meetings = React.createClass({
	...
	openUpdateModal: function() {
		...
		console.log(this.state.selectedMeetingId);
	},

	//BEGIN: Delete Meeting
	onDeleteBtnClicked: function() {

		axios.delete('http://localhost:9090/meetings/' + this.state.selectedMeetingId)
	...
	getMeetings: function() {
	  return axios.get('http://localhost:9090/meetings');
	},
