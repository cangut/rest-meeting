...
public class Manage {
	...
	public static void main(String[] args) {
		...
		m.setDescription("for Oracle");
		m.setName("Oracle Meeting");
		m.setDepartment(dlist);
		
		Meeting m1 = new Meeting();
		m1.setDescription("for Accountants");
		m1.setName("Accountant Meeting");
		m1.setDepartment(dlist);
		...
		new MeetingDAO().create(m1);
		new EmployeeDAO().create(e2);
		new EmployeeDAO().create(e);
